...
// TYPING EFFECT
// ===================================
const phrases = ['Mobile Developer', 'Android Engineer', 'Software Developer', 'Problem Solver'];
let phraseIndex = 0;
let charIndex = 0;
...
console.log('%c✨ Built with vanilla JavaScript, CSS, and lots of coffee', 'color: #ec4899; font-size: 12px;');
